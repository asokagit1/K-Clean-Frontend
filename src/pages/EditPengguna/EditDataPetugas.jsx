...
import './EditDataPetugas.css';

const EditDataPetugas = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            alert('Gagal memperbaharui data petugas. ' + (error.response?.data?.message || 'Terjadi kesalahan.'));
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="edit-petugas-container">
            <div className="header-section">
                ...
                <h1 className="page-title">Edit Data Petugas</h1>
            </div>
...
export default EditDataPetugas;
